...
declare const _default: {
    Performance: {
        new (): {
            timerify<T extends (...params: any[]) => any>(_fn: T, _options?: perf_hooks | undefined): T;
            readonly nodeTiming: perf_hooks;
            eventLoopUtilization(): perf_hooks;
            ...
            markResourceTiming(timingInfo: object, requestedUrl: string, initiatorType: string, global: object, cacheMode: "" | "local"): perf_hooks;
